...
- Work from top to bottom - Packages (libraries) always need to be loaded first!
...
1. Add a new R code chunk below this paragraph. 
2. Then use `cat()` to print:

``` text
A whole new chunk! ♪ 🌏 ♪
```

3. Run your new chunk to verify that it works.
...
Read in the data to the R `Environment` and call the object `raw_data`
```{r}
